      ...
      <div className="bg-orange-50 border border-orange-100 rounded-2xl p-6 relative overflow-hidden flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 items-center w-full md:w-auto mt-6 md:mt-0">
            ...
            <button
                ...
                className="bg-orange-600 text-white px-6 py-2 rounded-lg font-bold hover:bg-orange-700 transition-colors duration-300 w-full sm:w-auto shadow-md shadow-orange-200 focus-visible:outline focus-visible:outline-4 focus-visible:outline-orange-500 focus-visible:outline-offset-2"
                aria-label={`Select Varishtha Suraksha plan with ${selectedSumInsured} coverage`}
            >
                Select Plan
            </button>
        </div>
      ...
      <div className="flex justify-center">
        <div className="bg-gray-100 p-1.5 rounded-xl inline-flex relative" role="group" aria-label="Coverage filter">
          ...
          <button
            ...
            className={`relative z-10 px-8 py-2.5 rounded-lg text-sm font-bold transition-colors duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-orange-600 focus-visible:outline-offset-2 ${
