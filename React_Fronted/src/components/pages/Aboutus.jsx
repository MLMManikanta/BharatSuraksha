    ...
    <div className="bg-gray-50 text-gray-900 font-sans">
      ...
      <section className="bg-linear-to-b from-[#DDF0FF] to-[#B3DAFF] py-24 px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 items-center gap-12">
          ...
          <div className="relative z-10">
            ...
            <h1 className="mt-6 text-4xl md:text-5xl font-extrabold text-[#1A5EDB] leading-tight">
          ...
          <div className="flex justify-center">
            <div className="bg-white rounded-3xl shadow-2xl p-6 rotate-2 hover:rotate-0 transition duration-500">
              <img 
      ...
      <section className="py-24 px-6 text-center bg-white">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mt-16">
          {/* Card 1 */}
          <div className="bg-blue-50 p-8 rounded-3xl border border-blue-100 hover:shadow-xl transition duration-300 hover:-translate-y-2 flex flex-col items-center">
      ...
      <section className="py-20 px-6 bg-[#0A2A5E] text-white">
        <div className="max-w-5xl mx-auto text-center mb-16">
          <h2 className="text-3xl font-bold text-white">Our Mission & Values 🎯</h2>
          <p className="mt-4 text-blue-200 leading-relaxed max-w-3xl mx-auto">
        ...
        <div className="grid md:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {[
            ...
            <div key={idx} className="bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/20 text-center hover:bg-white/20 transition">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-6xl mx-auto mt-14">
          ...
          {[
            ...
            { type: 'emoji', src: "🛡️", title: "Extra Cover", desc: "Top-up options" }
             ...
             <div key={index} className="bg-white p-6 rounded-2xl shadow-sm hover:shadow-md transition text-center flex flex-col items-center">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-12 gap-8">
                ...
                {Object.keys(TERMS_DATA).map((key) => (
                  <li key={key}>
                    <button 
                      ...
                      className={`w-full text-left px-5 py-3 rounded-xl transition-all duration-200 font-medium ${
                        activeTab === key 
            ...
            <div className="md:col-span-8">
               <div className="bg-white p-10 rounded-3xl shadow-xl border border-blue-100 h-full flex flex-col justify-center animate-fade-in">
