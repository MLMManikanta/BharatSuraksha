    ...
    <BrowserRouter basename="/BharatSuraksha">
      <Routes>
        ...
        <Route
          ...
          element={
            <ProtectedRoute>
              <Navigate to="/claims/my-claims" replace />
            </ProtectedRoute>
          }
        />
        <Route
        ...
        <Route
          ...
          element={
            <ProtectedRoute>
              <Layout>
                <EntitlementDependents />
              </Layout>
            </ProtectedRoute>
          }
        />
        <Route
          path="/claims/entitlement"
          element={
            <ProtectedRoute>
              <Navigate to="/claims/entitlement-dependents" replace />
            </ProtectedRoute>
          }
        />
        <Route
        ...
        />
        <Route
          path="/claims/raise-claim/:dependentId"
          element={
            <ProtectedRoute>
              <Layout>
                <RaiseClaim />
        ...
        />
        <Route
          path="/claims/raise-new"
          element={
            <ProtectedRoute>
              <Navigate to="/claims/raise-claim" replace />
            </ProtectedRoute>
          }
        />
        <Route
        ...
        />
        <Route
          path="/utilities/justification-letter"
          element={
            <Layout>
              <JustificationLetter />
            </Layout>
        ...
        />
        <Route
          path="/utilities/claim-instructions"
          element={
            <Layout>
              <ClaimInstructions />
            </Layout>
